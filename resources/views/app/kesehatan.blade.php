...
@push('styles')
    <style>
        /* Override Bootstrap card styles untuk halaman ini */
        .kesehatan-page .card {
            border: none;
            border-radius: 12px;
        ...
        /* Summary Cards - Force Grid Layout */
        .kesehatan-page .summary-cards {
        ...
        .kesehatan-page .summary-card-icon {
            width: 40px;
            height: 40px;
            border-radius: 10px;
            display: flex;
        ...
        .kesehatan-page .summary-card-icon.anc {
            background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%);
            color: #1976d2;
        }

        .kesehatan-page .summary-card-icon.skrining {
            background: linear-gradient(135deg, #f3e5f5 0%, #e1bee7 100%);
            color: #7b1fa2;
        }

        .kesehatan-page .summary-card-icon.lab {
            background: linear-gradient(135deg, #fff3e0 0%, #ffe0b2 100%);
            color: #f57c00;
        }

        .kesehatan-page .summary-card-value {
            font-size: 20px;
            font-weight: 700;
            color: #333;
            margin: 0 0 3px 0;
        ...
        .kesehatan-page .summary-card-label {
            font-size: 11px;
            color: #666;
            margin: 0;
            line-height: 1;
        ...
        .kesehatan-page .filter-tab.active {
            background: linear-gradient(135deg, #ff6b9d 0%, #ff8fab 100%);
            color: white;
        }

        /* Timeline */
        .kesehatan-page .timeline {
            position: relative;
            padding-left: 30px;
        }

        .kesehatan-page .timeline::before {
            content: '';
            position: absolute;
            left: 10px;
            top: 0;
        ...
        .kesehatan-page .timeline-item {
            position: relative;
            margin-bottom: 25px;
        }

        .kesehatan-page .timeline-dot {
            position: absolute;
            left: -24px;
            top: 5px;
            width: 20px;
        ...
        .kesehatan-page .timeline-card:hover {
            box-shadow: 0 4px 15px rgba(255, 107, 157, 0.2);
            transform: translateY(-2px);
        }

        .kesehatan-page .timeline-header {
            display: flex;
        ...
        .kesehatan-page .timeline-date {
            display: flex;
            flex-direction: column;
        }

        .kesehatan-page .timeline-day {
            font-size: 18px;
            font-weight: 700;
            color: #ff6b9d;
        }

        .kesehatan-page .timeline-month {
            font-size: 11px;
            color: #999;
        }

        .kesehatan-page .timeline-badge {
            background: #ff6b9d;
            color: white;
            padding: 4px 10px;
            border-radius: 12px;
        ...
        .kesehatan-page .timeline-badge.krr {
            background: #28a745;
        }

        .kesehatan-page .timeline-badge.krt {
            background: #ffc107;
            color: #333;
        }

        .kesehatan-page .timeline-badge.krst {
            background: #dc3545;
        }

        .kesehatan-page .timeline-title {
            font-weight: 700;
            color: #333;
            margin-bottom: 8px;
            font-size: 14px;
        ...
        .kesehatan-page .timeline-info {
            display: flex;
            flex-direction: column;
            gap: 5px;
        }

        .kesehatan-page .info-item {
            display: flex;
            align-items: center;
            gap: 8px;
            font-size: 12px;
        ...
        .kesehatan-page .info-item i {
            color: #ff6b9d;
            width: 14px;
        }

        .kesehatan-page .timeline-details {
            margin-top: 15px;
            padding-top: 15px;
            border-top: 1px dashed #e0e0e0;
        }

        .kesehatan-page .timeline-details.hidden {
            display: none;
        }

        .kesehatan-page .detail-row {
            display: flex;
            justify-content: space-between;
            padding: 8px 0;
            font-size: 13px;
        ...
        .kesehatan-page .detail-label {
            color: #666;
            font-weight: 500;
        }

        .kesehatan-page .detail-value {
            color: #333;
            font-weight: 600;
            text-align: right;
        }

        .kesehatan-page .detail-value.normal {
            color: #28a745;
        }

        .kesehatan-page .expand-btn {
            width: 100%;
            margin-top: 10px;
            padding: 8px;
            background: #f5f5f5;
        ...
        .kesehatan-page .expand-btn:hover {
            background: #ffe8f2;
        }

        .kesehatan-page .expand-btn.expanded i {
            transform: rotate(180deg);
        }

        .kesehatan-page .empty-state {
            text-align: center;
            padding: 60px 20px;
        }

        .kesehatan-page .empty-icon {
            font-size: 60px;
            color: #ddd;
            margin-bottom: 20px;
        }

        .kesehatan-page .empty-title {
            font-size: 18px;
            font-weight: 700;
            color: #999;
            margin-bottom: 10px;
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-card">
                                ...
                                <div class="timeline-info">
                                    ...
                                    @endif
                                    <div class="info-item"><i class="fas fa-clock"></i><span>UK:
                                            {{ $p->usia_kehamilan_minggu }}
                                            minggu</span></div>
                                </div>
                                <div class="timeline-details hidden" id="details-anc-{{ $p->id }}">
                                    ...
                                    @if ($p->denyut_jantung_janin)
                                        <div class="detail-row"><span class="detail-label">DJJ:</span><span
                                                class="detail-value normal">{{ $p->denyut_jantung_janin }} x/mnt</span>
                                        </div>
                                    @endif
                                </div>
