...
class PuskesmasPolicy
{
    ...
    {
        return $user->can('view_any_puskesmas');
    }
    ...
    {
        return $user->can('view_puskesmas');
    }
    ...
    {
        return $user->can('create_puskesmas');
    }
    ...
    {
        return $user->can('update_puskesmas');
    }
    ...
    {
        return $user->can('delete_puskesmas');
    }
    ...
    {
        return $user->can('delete_any_puskesmas');
    }
