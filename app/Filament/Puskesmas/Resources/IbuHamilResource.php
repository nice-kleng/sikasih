                    ...
                    ->schema([
                        Forms\Components\Hidden::make('puskesmas_id')
                            ->default(function () {
                                ...
                                if ($user->puskesmas) {
                                    ...
                                    return $user->tenagaKesehatan->puskesmas_id;
                                }
                                return null;
                            })
                            ->required(),
                        Forms\Components\TextInput::make('no_rm')
                            ...
                            ->default(function () {
                                ...
                                $lastRM = IbuHamil::where('puskesmas_id', $puskesmasId)->max('no_rm');
